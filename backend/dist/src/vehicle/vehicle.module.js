...
VehicleModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: vehicle_schema_1.Vehicle.name, schema: vehicle_schema_1.VehicleSchema }])],
        ...
        exports: [vehicle_service_1.VehicleService, vehicle_repository_1.VehicleRepository],
    })
], VehicleModule);
